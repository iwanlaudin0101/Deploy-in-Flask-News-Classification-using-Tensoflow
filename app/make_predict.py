...
class MakePredict:
    ...
    def preprocessing(self):
        START = time.time()
        print("Tahap prapemrosesan data Mulai", START, "Detik")
        ...
        END = time.time()
        print("Tahap prapemrosesan data Selesai", END-START, "Detik")
        return filtered
    ...
    def sequncesPadding(self):
        ...
        print("Tahap Sequens dan Padding")
        return seq_padding
    ...
    def filePredict(self):
        ...
        fitures = self.sequncesPadding()
        START = time.time()
        print("Tahap prediksi Mulai", START)
        ...
        END = time.time()
        print("Tahap prediksi Selesai", END-START, "Detik")
        return self.result
